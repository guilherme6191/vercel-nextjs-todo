    ...
    <ul className="w-full mx-auto pt-20 px-4">
      {list.map((item) => (
        ...
        >
          ...
          <label
            className={`mt-px cursor-pointer select-none font-light text-white text-3xl ${item.is_done ? 'line-through' : ''}`}
          >
            {item.message}
          </label>
        </li>
...
<label class="relative flex cursor-pointer items-center rounded-full p-3" for="checkbox-3" data-ripple-dark="true">
  <input
    type="checkbox"
